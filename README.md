...
`CONDA_CACHE_DIR`, `CONDA_PKGS_DIRS`, `CONDA_ENVS_DIRS`, `PIP_CACHE_DIR`, and `TMPDIR`
at scratch or scrubbed storage. The bootstrap script now exports those values before running
`conda` or `pip`.
