...
reflection_type="reflection_only" # "reflection_only" or "history_and_reflection" or "history_only" --> paper shows "reflection_only" works best

# Maze path length.  Must be even and >= 2.
# n=4  → 4-step optimal path, ~5×5 display grid  (easy, start here)
# n=6  → 6-step path,         ~7×7 grid           (medium)
# n=8  → 8-step path,         ~9×9 grid           (hard)
maze_n=6

experiment_name=maze_lamer_base_6_step
