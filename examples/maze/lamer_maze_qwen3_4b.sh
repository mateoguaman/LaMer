...
python3 -m verl.trainer.main_ppo \
    ...
    env.maze.maze_size=9 \
    env.maze.plan_length=5 \
    env.maze.sticky_prob=0.1 \
    env.maze.double_prob=0.1 \
    env.maze.noise_prob=0.1 \
    'env.maze.unavail_actions=[]' \
    env.num_attempts=3 \
    env.max_steps=50 \
    env.max_turns=10 \
    ...
    trainer.experiment_name=maze_lamer_qwen3_4b \
    ...
    2>&1 | tee -a ../maze_lamer_qwen3_4b.log
